    ...
    public class AdmAnnoController : Controller
    {
        ...
        public IActionResult Query(QueryIn inModel)
        {
			...
			using (var cn = new SqlConnection(connStr))
            {
                ...
                /*
                using (var cn2= new SqlConnection(connStr))
                {
                    string sql = @"SELECT * from TEST ORDER BY AnnoDate desc ";
                    ...
                    var list = cn2.Query<AnnoModel>(sql, param);
